...
from pipeworks_namegen_api.webapp import endpoint_adapters as endpoint_adapters_module
from pipeworks_namegen_api.webapp.generation import (
    _coerce_render_style,
    get_cached_generation_package_options,
)
from pipeworks_namegen_api.webapp.handler import WebAppHandler
...
def test_help_contract(tmp_path: Path) -> None:
    ...
    from pipeworks_namegen_api.webapp import help_content
...
def test_get_version_contract(tmp_path: Path) -> None:
    ...
    from pipeworks_namegen_api.webapp.endpoint_adapters import get_version
...
def test_get_root_injects_version(tmp_path: Path, monkeypatch: Any) -> None:
    ...
    from pipeworks_namegen_api import __version__
    from pipeworks_namegen_api.webapp.endpoint_adapters import get_root
    ...
    with mock_patch(
        "pipeworks_namegen_api.webapp.endpoint_adapters.get_index_html",
        ...
        with mock_patch(
            "pipeworks_namegen_api.webapp.endpoint_adapters.static_routes.get_root",
